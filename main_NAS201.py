...
#######################################
s = time.time()
searchspace = create('./designspace/NAS-Bench-201/NATS-tss-v1_0-3ffb9-simple', 'tss', fast_mode=True, verbose=False)
e = time.time()
print('DONE')
...
for r in range(maxtrials):
  ...
  for uid in batch_space:
    ...
    accuracy, latency, time_cost, current_total_time_cost = searchspace.simulate_train_eval(uid, dataset=dataset, hp='200')
