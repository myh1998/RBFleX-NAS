...
class PreTrainedModel(nn.Module, ModuleUtilsMixin, GenerationMixin, PushToHubMixin):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], ACTIVATION, *model_args, **kwargs):
        r"""
        ...
        if is_deepspeed_zero3_enabled():
            ...
            with no_init_weights(_enable=_fast_init):
                model = cls(config, ACTIVATION=ACTIVATION, *model_args, **model_kwargs)
